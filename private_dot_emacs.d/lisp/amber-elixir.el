...
(defun amber-elixir/project-try-mix (dir)
  "Find super-directory of DIR containing mix.exs file."
...
(add-hook 'project-find-functions #'amber-elixir/project-try-mix)
